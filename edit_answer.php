...
?>
 ...
 if($_POST){
     ...
     try{
         $query = "UPDATE answers SET answered=:answered WHERE id = :id";
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            <td>Answer</td>
            <td><textarea name='answered' class='form-control'><?php echo htmlspecialchars($instructions, ENT_QUOTES);  ?></textarea></td>
        </tr>
        <tr>
            <td></td>
            <td>
